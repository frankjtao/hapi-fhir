...
public class EmpiEidInterceptorGenderR4Test extends BaseJpaR4Test {
    ...
    private static final org.slf4j.Logger ourLog = org.slf4j.LoggerFactory.getLogger(EmpiEidInterceptorGenderR4Test.class);
    ...
    public void testJpaCreateNewPerson() {
        ...
        thePerson.setGender(AdministrativeGender.MALE);
    ...
    @Test
    //-- create a new Person, check EID is injected
    public void testJpaCreateNewPersonWithoutGender() {
    ...
    @Test
    //-- create two person with same name, birth date and gender
    public void testJpaCreateSamePerson() {
        ...
        thePerson1.setGender(AdministrativeGender.MALE);
    ...
    @Test
    //-- create two person with same name, and birth date, diff Gender
    public void testJpaCreateSamePersonDiffGender() {
    ...
    public void testJpaCreateSamePersonWithoutGender() {
